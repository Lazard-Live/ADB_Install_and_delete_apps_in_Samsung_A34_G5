...
def show_nav():
    print("┌────────────────────────────────────────────")
    print("│ Меню:")
    print("│ 1. Автоматический режим (удаление -> установка -> отключение ADB и выход)")
    print("│ 2. Установка приложений")
    print("│ 3. Удаление приложений")
    print("│ 4. Отключение ADB и Выход")
...
def check_device():
    ...
    print("│ S/N:")
    subprocess.run('adb get-serialno')
